...
Godot 4.7.2, GDScript, renderizador Compatibility. Cena principal: `scenes/arena.tscn`. Jogo local 3×3 com um jogador e cinco bots. Base atual: câmera tática elevada, WASD relativo à tela e mouse livre para mirar.
